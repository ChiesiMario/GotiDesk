...
<main class="h-screen bg-white dark:bg-gray-900 text-black dark:text-gray-100 relative overflow-hidden flex flex-col selection:bg-black selection:text-white antialiased">
  ...
  <!-- Custom Titlebar -->
  <div data-tauri-drag-region onmousedown={(e) => { if (e.target === e.currentTarget && e.button === 0) getCurrentWindow().startDragging(); }} class="h-7 w-full flex items-center justify-end shrink-0 select-none cursor-default">
